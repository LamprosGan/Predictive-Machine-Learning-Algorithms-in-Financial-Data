...
class StockEnv(gym.Env, ABC):
    ...
    def step(self, action):
        ...
        # print("step:")
        # print("next_state['volumes'].shape:", next_state['volumes'].shape)
    ...
    def compute_state_features(self):
        ...
        # print("compute_state_features:")
        # print("pos:", self.pos)
        # print("last_n_ticks:", self.last_n_ticks)
        # print("scaled_snapshot_state shape:", self.scaled_snapshot_state.shape)
    ...
    def create_state(self):
        ...
        # print("create_state:")
        # print("volumes shape:", np.array(self.state).flatten().shape)
        return state
